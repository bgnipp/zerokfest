...
- **Old path:** [2kfest.com/zerok](https://2kfest.com/zerok/) redirects here

Same publish shape as 9k: public GitHub repo → GitHub Pages from `main` `/` → apex domain in `CNAME`.

See [PUBLISH.md](PUBLISH.md) for DNS and GoDaddy.
